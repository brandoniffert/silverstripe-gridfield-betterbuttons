...
class BetterButtonPrevNextAction extends BetterButtonAction
{
    ...
    public function getButtonHTML()
    {
        ...
        $html .= sprintf(
            "<a class='ss-ui-button btn btn-default gridfield-better-buttons-prevnext gridfield-better-buttons-prev %s' href='%s' title='%s'><img src='/resources/betterbuttons/images/prev.png' alt='previous'  /> %s</a>",
            $cssClass,
            $prevLink,
            $linkTitle,
            $linkText
        ...
        $html .= sprintf(
            "<a class='ss-ui-button btn btn-default gridfield-better-buttons-prevnext gridfield-better-buttons-next %s' href='%s' title='%s'>%s <img src='/resources/betterbuttons/images/next.png' alt='next'  /></a>",
            $cssClass,
            $nextLink,
            $linkTitle,
            $linkText
